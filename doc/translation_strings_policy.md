...
This document provides guidelines for internationalization of the Alphacon Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `alphacon_en.ts` remains unchanged.
