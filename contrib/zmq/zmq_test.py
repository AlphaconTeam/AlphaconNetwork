...
"""
    ...
    Alphacon should be started with the command line arguments:
        alphacond -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND ALP issuance at " + str(pos))
				print("After ALP: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND ALP something at " + str(pos))
			start += pos+8
			print(astr)
