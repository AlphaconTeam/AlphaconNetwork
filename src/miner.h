...
#ifndef ALPHACON_MINER_H
#define ALPHACON_MINER_H
...
public:
    ...
    std::unique_ptr<CBlockTemplate> CreateNewBlockAlp(const CScript& scriptPubKeyIn, bool fMineWitnessTx=true, bool fProofOfStake=false, int64_t* pTotalFees = 0, int32_t nTime=0);
