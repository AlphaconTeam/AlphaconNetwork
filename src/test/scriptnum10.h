...
#ifndef ALPHACON_TEST_SCRIPTNUM10_H
#define ALPHACON_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Alphacon Core 0.10.0, for cross-comparison.
 */
public:
