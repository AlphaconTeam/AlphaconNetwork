...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Alphacon", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Alphacon</b> version", 0));
...
"Copyright \302\251 2018 The Alphacon developers", 0));
