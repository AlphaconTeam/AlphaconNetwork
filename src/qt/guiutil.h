...
#ifndef ALPHACON_QT_GUIUTIL_H
#define ALPHACON_QT_GUIUTIL_H
...
/** Utility functions used by the Alphacon Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "alphacon:" URI into recipient object, return true on successful parsing
