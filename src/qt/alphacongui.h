...
#ifndef ALPHACON_QT_ALPHACONGUI_H
#define ALPHACON_QT_ALPHACONGUI_H
...
/**
  Alphacon GUI main class. This class represents the main window of the Alphacon UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AlphaconGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AlphaconGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~AlphaconGUI();
...
#endif // ALPHACON_QT_ALPHACONGUI_H
