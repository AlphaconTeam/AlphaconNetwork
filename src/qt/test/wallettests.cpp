...
#include "qt/alphaconamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<AlphaconAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_alphacon-qt -platform xcb      # Linux
//     src/qt/test/test_alphacon-qt -platform windows  # Windows
//     src/qt/test/test_alphacon-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = AlphaconUnits::formatWithUnit(unit, balance, false, AlphaconUnits::separatorAlways);
    ...
    // Amount input
    AlphaconAmountField* amountInput = receiveCoinsDialog.findChild<AlphaconAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: alphacon:")) != -1);
