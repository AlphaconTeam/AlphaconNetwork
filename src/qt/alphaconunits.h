...
#ifndef ALPHACON_QT_ALPHACONUNITS_H
#define ALPHACON_QT_ALPHACONUNITS_H
...
/** Alphacon unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AlphaconUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AlphaconUnits(QObject *parent);

    /** Alphacon units.
      @note Source: https://en.alphacon.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ALP,
...
typedef AlphaconUnits::Unit AlphaconUnit;

#endif // ALPHACON_QT_ALPHACONUNITS_H
