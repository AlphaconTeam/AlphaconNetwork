...
#ifndef ALPHACON_HASH_H
#define ALPHACON_HASH_H
#include <iostream>
#include <chrono>
...
/** A hasher class for Alphacon's 256-bit hash (double SHA-256). */
class CHash256 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for Alphacon's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
    CSHA256 sha;
public:
...
template <typename T1>
inline uint256 groestlhash(const T1 pbegin, const T1 pend)
{
    static unsigned char pblank[1];
