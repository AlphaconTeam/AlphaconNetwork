...
class AssetTest(AlphaconTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("ALPHACON1", 1000)
        n0.issue("ALPHACON2", 1000)
        n0.issue("ALPHACON3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="ALPHACON*", verbose=False, count=2, start=-2)
        ...
        alphacon_assets = n0.listassets(asset="ALPHACON*", verbose=False, count=2, start=-2)
        assert_equal(len(alphacon_assets), 2)
        assert_equal(alphacon_assets[0], "ALPHACON2")
        assert_equal(alphacon_assets[1], "ALPHACON3")
        self.sync_all()
