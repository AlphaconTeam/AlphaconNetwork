...
class BIP66Test(AlphaconTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # alphacond is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and alphacond produces more specific reject
            # reasons.
