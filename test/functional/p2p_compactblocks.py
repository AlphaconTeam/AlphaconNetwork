...
# TestNode: A peer we use to send messages to alphacond, and store responses.
...
class CompactBlocksTest(AlphaconTestFramework):
    ...
    # This test actually causes alphacond to (reasonably!) disconnect us, so do this last.
    ...
    # Test that alphacond requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for alphacond to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # alphacond will not send blocktxn responses for blocks whose height is
