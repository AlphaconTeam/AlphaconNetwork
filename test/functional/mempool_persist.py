...
By default, alphacond will dump mempool on shutdown and
...
class MempoolPersistTest(AlphaconTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give alphacond a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent alphacond from writing mempool.dat to disk. Verify that `savemempool` fails")
