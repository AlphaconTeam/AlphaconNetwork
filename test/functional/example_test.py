...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AlphaconTestFramework
    pass

class ExampleTest(AlphaconTestFramework):
    # Each functional test is a subclass of the AlphaconTestFramework class.
    ...
    def custom_method(self):
        ...
        AlphaconTestFramework class so other tests can use it."""
