...
class TxnMallTest(AlphaconTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 ALP:
        ...
        # First: use raw transaction API to send 1240 ALP to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 ALP coin each
        ...
        # Node0's balance should be starting balance, plus 50ALP for another
        ...
        # Node0's total balance should be starting balance, plus 100ALP for 
