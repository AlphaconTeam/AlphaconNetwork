...
from test_framework.test_framework import AlphaconTestFramework, SkipTest
...
class ZMQTest (AlphaconTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that alphacon has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("alphacond has not been built with zmq enabled.")
