...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Alphacon - Debug window", nullptr));
        label_9->setText(QApplication::translate("RPCConsole", "Alphacon Core", nullptr));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Alphacon debug log file from the current data directory. This can take a few seconds for large log files.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Alphacon-Qt help message to get a list with possible Alphacon command-line options.", nullptr));
#endif // QT_NO_TOOLTIP
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("RPCConsole", "&Network Traffic", nullptr));
    } // retranslateUi
